...
const FAQS_DATA: FaqItem[] = [
  ...
  {
    id: 'faq-registo-explicado',
    category: 'candidates',
    question: 'Como funciona o processo de registo na Tarira para profissionais e técnicos?',
    answer: 'O registo é feito online em minutos. O seu perfil é analisado por especialistas de seleção, os seus documentos são checados (BI, certificados, carteiras técnicas) e você passa a fazer parte do banco de dados homologado da Tarira. Quando surgem requisições de empresas parceiras, os perfis verificados são priorizados na entrega das shortlists corporativas.',
    badge: 'Passo a Passo'
  },
  {
    id: 'faq-4',
    ...
    <div className="w-full bg-[#f8fafc] text-slate-900 min-h-screen">
      ...
      <section className="bg-gradient-to-b from-[#172554] via-[#1e3a8a] to-[#172554] text-white px-4 sm:px-6 py-14 sm:py-20 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10 text-center space-y-5">
          ...
          {/* Hero Quick Navigation to Jobs */}
          <div className="pt-1">
            <button
              type="button"
              onClick={onNavigateToJobs}
              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white/10 hover:bg-white/20 border border-white/20 text-white !text-white text-xs font-semibold transition-all cursor-pointer shadow-sm active:scale-95"
              title="Aceder ao Portal de Vagas, Oportunidades & Carreiras"
            >
              <Briefcase className="w-3.5 h-3.5 text-blue-300" />
              <span>Procura vagas ou contratação corporativa? Ver Vagas & Carreiras</span>
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 py-8 space-y-3">
        {/* Featured Registration Card: Como funciona o registo na Tarira */}
        {(selectedCategory === 'all' || selectedCategory === 'candidates') && (
          <div className="bg-white border border-slate-200 hover:border-blue-300 rounded-3xl p-6 sm:p-7 shadow-xs hover:shadow-md transition-all space-y-4 mb-4">
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 text-xs text-slate-700">
              <li className="flex items-center gap-2 bg-slate-50 p-2.5 rounded-xl border border-slate-200/70">
                <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" />
                <span><strong>100% Gratuito</strong> para o candidato em todas as fases</span>
              </li>
              <li className="flex items-center gap-2 bg-slate-50 p-2.5 rounded-xl border border-slate-200/70">
                <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 pt-2">
              ...
              <button
                ...
                className="px-4 py-2.5 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-800 text-xs font-bold transition-all flex items-center justify-center gap-2 cursor-pointer active:scale-95 border border-slate-200"
              >
      ...
      {/* 4.5. Fast-track to Opportunities, Jobs & Careers */}
        ...
        <div className="bg-gradient-to-r from-[#1e3a8a] via-[#172554] to-[#0f172a] rounded-3xl p-6 sm:p-7 text-white shadow-xl flex flex-col md:flex-row items-center justify-between gap-5 border border-blue-400/30">
          <div className="space-y-1.5 text-center md:text-left">
            ...
            <p className="text-xs text-blue-100/80 leading-relaxed max-w-lg">
              Explore o nosso banco de oportunidades corporativas ou submeta a sua candidatura espontânea.
            </p>
          </div>
          ...
          <div className="flex items-center justify-center shrink-0">
            <button
              type="button"
              onClick={onNavigateToJobs}
              className="px-5 py-2.5 rounded-xl bg-white text-[#172554] hover:bg-blue-50 text-xs font-bold transition-all cursor-pointer shadow-md active:scale-95 flex items-center gap-2"
            >
              <Briefcase className="w-4 h-4 text-[#172554]" />
              <span>Ver Vagas & Oportunidades</span>
